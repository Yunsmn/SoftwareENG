package CodeQuest.Main; // tu declare qu cette class main appartient au package CodeQuest.Main cela permet d'avoir une organization et pas de conflit ds nom
import javax.swing.*; // c'est la bibliotheque ces interface graphiqu en java
import java.awt.*;// importe les classe necessaire pour l'affichage et la gestion des interface graphique en java
import java.awt.event.*;// importe des class lieés au evenement
